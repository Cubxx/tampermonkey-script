(() => {
    ...
    Element.prototype.attachShadow = function () {
        return _.call(this, { mode: 'open' });
    };
})();
(() => {
    const { trustedTypes: t } = window;
    if (!t) return;
    const p = t.createPolicy('tm-policy', { createHTML: (e) => e });
    const _ = Object.getOwnPropertyDescriptor(Element.prototype, 'innerHTML');
    Object.defineProperty(Element.prototype, 'innerHTML', {
        ..._,
        set(v){_?.set.call(this,p.createHTML(v))},
    });
})();
