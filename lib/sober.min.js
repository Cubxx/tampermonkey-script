!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):(e="undefined"!=typeof globalThis?globalThis:e||self).sober=t()}(this,function(){"use strict";const c=new CSSStyleSheet;c.replaceSync(":host{ user-select: none;-webkit-user-select: none }");var e=a=>{const o=new CSSStyleSheet;o.replaceSync(a.style??"");var e=[];const r={};for(const s in a.props){var t=s.toLowerCase();e.push(t),r[t]=s}const l=new Map;class n extends HTMLElement{static observedAttributes=e;static define(e){customElements.define(e,this)}constructor(){super();var e=this.attachShadow({mode:"open"});e.adoptedStyleSheets=[c,o],e.innerHTML=a.template??"";const n={...a.props},s=a.setup?.apply(this,[e]);for(const i in a.props)Object.defineProperty(this,i,{get:()=>n[i],set:e=>{e=((e,t)=>{if(void 0===e)return t;if("string"==typeof t)return String(e);if("number"==typeof t)return Number(e);if("boolean"==typeof t)return"boolean"==typeof e?e:"true"===e;throw new TypeError})(e,a.props[i]);if(e!==n[i]){if(!0===a.syncProps||a.syncProps?.includes(i)){var t=i.toLowerCase(),o=this.getAttribute(t),r=String(e);if(e===a.props?.[i]&&null!==o)return void this.removeAttribute(t);if(e!==a.props?.[i]&&o!==r)return void this.setAttribute(t,r)}n[i]=e,s?.watches?.[i]?.(e)}}});for(const t in s?.expose)Object.defineProperty(this,t,{get:()=>s?.expose[t]});l.set(this,s)}connectedCallback(){l.get(this)?.mounted?.()}disconnectedCallback(){l.get(this)?.unmounted?.()}adoptedCallback(){l.get(this)?.adopted?.()}attributeChangedCallback(e,t,o){this[r[e]]=o??void 0}}return n};class t extends e({style:`
:host{
  display: flex;
  height: 64px;
...
`,template:"<slot></slot>",props:{}}){}o.define("s-badge");const r=matchMedia("(pointer:coarse)"),d=(r.addEventListener("change",({matches:e})=>d.touched=e),{touched:r.matches,addEventListener:e=>r.addEventListener("change",()=>e(d.touched))}),n=document.createElement("div"),l=(n.setAttribute("style","position: fixed;right: 0;bottom: 0;width: 100%;height: 100%;pointer-events: none"),e=>{e.appendChild(n);var t=n.getBoundingClientRect();return e.removeChild(n),{left:t.left,top:t.top,width:t.width,height:t.height}});const p=e=>{const t=()=>{e(),document.removeEventListener("pointerup",t),document.removeEventListener("pointercancel",t)};document.addEventListener("pointerup",t),document.addEventListener("pointercancel",t)};class s extends e({style:`
:host{
...
<slot name="end"></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`,props:{type:"elevated",clickable:!1},syncProps:!0,setup(e){e.querySelector("slot[name=action]").addEventListener("pointerdown",e=>e.stopPropagation())}}){}a.define("s-card");class h extends e({style:`
:host{
  display: block;
  height: 280px;
  background: var(--s-color-surface-container-low, #f6f2f7);
...
`,props:{duration:4e3},setup(e){const t=e.querySelector(".container"),s=e.querySelector(".dot"),i=e.querySelector("slot");let a=0,l=0,o=0;const r=()=>{t.style.transform=`translateX(-${100*a}%)`,s.querySelector(".checked")?.classList.remove("checked"),s.children[a]?.classList.add("checked")},c=()=>{clearInterval(o),r(),0!==l&&(o=setInterval(()=>{var e=a+1;a=e===l?0:e,r()},this.duration))};return i.addEventListener("slotchange",()=>{s.innerHTML="";var e=i.assignedElements(),t=document.createDocumentFragment();for(const r in e){var o=document.createElement("div");const n=Number(r);o.className=0===n?"item checked":"item",o.setAttribute("part","dot"),o.addEventListener("click",()=>{a=n,c()}),t.appendChild(o)}l=e.length,s.appendChild(t),a=0,c()}),{mounted:c,unmounted:()=>clearInterval(o),watches:{duration:c}}}}){}h.define("s-carousel");const v={indeterminate:"M280-440h400v-80H280v80Zm-80 320q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Z",uncheck:"M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560H200v560Z",checked:"m424-312 282-282-56-56-226 226-114-114-56 56 170 170ZM200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Z"};var u=`
<svg class="icon color" viewBox="0 -960 960 960">
  <path d="${v.uncheck}"></path>
</svg>
<s-ripple class="color" attached="true" part="ripple"></s-ripple>
`;class f extends e({style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  align-items: center;
...
<slot name="action"></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`,props:{type:"outlined",clickable:!1},syncProps:!0,setup(e){e.querySelector("slot[name=action]").addEventListener("pointerdown",e=>e.stopPropagation())}}){}m.define("s-chip");const x=44*Math.PI;u=`
...
`,template:u,props:{indeterminate:!1,animated:!1,max:100,value:0},syncProps:["indeterminate","animated"],setup(e){const r=e.querySelector(".known .track"),n=e.querySelector(".known .indicator");e=()=>{var e=Math.min(this.value,this.max)/this.max*100,t=x-x*(e/100),o=e/100*360;r.style.strokeDashoffset=`${0==e?0:Math.min(16+x-t,x)}px`,r.setAttribute("transform",`rotate(${20+o}, 24, 24)`),n.style.strokeDashoffset=t+"px"};return{watches:{max:e,value:e}}}}){}g.define("s-circular-progress");class b extends e({style:`
:host{
  display: block;
  overflow: auto;
}
...
`,props:{size:"basic"},syncProps:["size"],setup(t){var e=t.querySelector("slot[name=trigger]");const o=t.querySelector(".wrapper");var r=t.querySelector(".scrim"),n=t.querySelector(".action"),s=()=>{var e=l(t);0===e.top&&0===e.left||o.setAttribute("style",`width: ${innerWidth}px;height: ${innerHeight}px;top: ${0-e.top}px;left: ${0-e.left}px`),o.classList.add("show"),this.dispatchEvent(new Event("show"))},i=()=>{o.classList.remove("show"),this.dispatchEvent(new Event("dismiss"))};return e.addEventListener("click",s),o.addEventListener("transitionend",e=>{"transform"===e.propertyName&&(e=o.classList.contains("show"),this.dispatchEvent(new Event(e?"showed":"dismissed")))}),r.addEventListener("click",i),n.addEventListener("click",i),{expose:{show:s,dismiss:i}}}}){static show=e=>{let t=document.body;const o=new y;var r=document.body.firstElementChild;if(r&&"S-PAGE"===r.tagName&&(t=r),"string"==typeof e){var r=document.createElement("div");r.slot="text",r.textContent=e,o.appendChild(r)}else{e.root&&(t=e.root),e.headline&&((r=document.createElement("div")).slot="headline",r.textContent=e.headline,o.appendChild(r)),e.text&&((r=document.createElement("div")).slot="text",r.textContent=e.text,o.appendChild(r)),e.view&&("function"==typeof e.view?e.view(o):o.appendChild(e.view));for(const s of e.actions??[]){var n=document.createElement("s-button");n.slot="action",n.type="text",n.textContent=s.text,s.click&&n.addEventListener("click",s.click),o.appendChild(n)}}t.appendChild(o),o.addEventListener("dismissed",()=>t.removeChild(o)),o.show()}}y.define("s-dialog");class w extends e({style:`
:host{
  display: block;
  height: 1px;
  background: var(--s-color-outline-variant, #c7c5d0);
...
`,props:{fold:840},setup(e){const n=e.querySelector(".container");var t=e.querySelector(".scrim");const s={start:e.querySelector(".start"),end:e.querySelector(".end"),startSlot:e.querySelector("slot[name=start]"),endSlot:e.querySelector("slot[name=end]")},i={start:null,end:null},a=200,r=(e="start",t)=>{var t=void 0===t?n.classList.contains("folded"):t,o=t?"show-fold-"+e:"show-"+e;n.classList.contains(o)||(n.classList.add(o),o=i[e]?.offsetWidth??0,t=t?[{transform:`translateX(${"start"===e?-1*o:o}px)`},{transform:"translateX(0px)"}]:[{width:0},{width:o+"px"}],s[e].animate(t,{duration:a}))},l=(e="start",t)=>{var o,t=void 0===t?n.classList.contains("folded"):t,r=t?"show-fold-"+e:"show-"+e;n.classList.contains(r)&&(o=i[e]?.offsetWidth??0,n.classList.remove(r),r=t?[{transform:"translateX(0px)",visibility:"visible"},{transform:`translateX(${"start"===e?-1*o:o}px)`,visibility:"visible"}]:[{width:o+"px"},{width:0}],s[e].animate(r,{duration:a}))};return new ResizeObserver(()=>this.offsetWidth<this.fold?n.classList.add("folded"):n.classList.remove("folded")).observe(this),t.addEventListener("click",()=>{l("start"),l("end")}),s.startSlot.addEventListener("slotchange",()=>i.start=s.startSlot.assignedElements()[0]),s.endSlot.addEventListener("slotchange",()=>i.end=s.endSlot.assignedElements()[0]),{expose:{show:r,dismiss:l,toggle:(e="start",t)=>{var o=(void 0===t?n.classList.contains("folded"):t)?"show-fold-"+e:"show-"+e;(n.classList.contains(o)?l:r)(e,t)}}}}}){}k.define("s-drawer");class q extends e({style:`
:host{
  display: inline-block;
  vertical-align: middle;
  text-align: start;
...
`,props:{showAlign:"center"},setup(e){const s=e.querySelector("#trigger"),i=e.querySelector(".wrapper");var t=e.querySelector(".scrim");const a=e.querySelector(".container"),r=(t,o,r)=>{if(this.isConnected&&!i.classList.contains("show")){var n=l(e),n=(0===n.top&&0===n.left||i.setAttribute("style",`width: ${innerWidth}px;height: ${innerHeight}px;top: ${0-n.top}px;left: ${0-n.left}px`),{top:0,left:0,origin:[]});if("number"==typeof t&&o&&(n.top=o,n.left=t,n.origin=r?r.split(" "):["left","top"],t+a.offsetWidth>innerWidth&&(n.left=t-a.offsetWidth,n.origin[0]="right"),o+a.offsetHeight>innerHeight)&&(n.top=o-a.offsetHeight,n.origin[1]="bottom"),void 0===t||t instanceof HTMLElement){r=(t||s).getBoundingClientRect(),o=a.offsetWidth,t=a.offsetHeight;n.origin=["center","top"],n.top=r.y+r.height,n.left=r.x-(o-r.width)/2;let e={left:{value:r.x,origin:"left"},right:{value:r.x+r.width-o,origin:"right"},top:{value:r.top-t,origin:"bottom"}};"left"===this.showAlign&&(n.origin[0]="right",n.left=r.x-o,n.top=r.y,e={left:{value:r.x+r.width,origin:"left"},right:{value:n.left,origin:n.origin[0]},top:{value:r.y+r.height-t,origin:"bottom"}}),"right"===this.showAlign&&(n.origin[0]="left",n.left=r.x+r.width,n.top=r.y,e={left:{value:n.left,origin:n.origin[0]},right:{value:r.x-o,origin:"right"},top:{value:r.y+r.height-t,origin:"bottom"}}),n.left<0&&(n.origin[0]=e.left.origin,n.left=e.left.value),n.left+o>innerWidth&&(n.origin[0]=e.right.origin,n.left=Math.max(e.right.value,0)),n.top+t>innerHeight&&(n.origin[1]=e.top.origin,n.top=Math.max(e.top.value,0))}a.style.transformOrigin=n.origin.join(" "),a.style.top=n.top+"px",a.style.left=n.left+"px",i.classList.add("show"),a.animate([{transform:"scale(.9)",opacity:0},{transform:"scale(1)",opacity:1}],{duration:100})}},n=()=>{this.isConnected&&i.classList.contains("show")&&(i.classList.remove("show"),a.animate([{transform:"scale(1)",opacity:1},{transform:"scale(.9)",opacity:0}],{duration:100}))};return s.addEventListener("click",()=>r()),t.addEventListener("pointerdown",n),{expose:{show:r,dismiss:n,toggle:(e,t,o)=>{this.isConnected&&(i.classList.contains("show")?n():r(e,t,o))}},mounted:()=>addEventListener("resize",n),unmounted:()=>removeEventListener("resize",n)}}}){}q.define("s-popup");class H extends e({style:`
:host{
  display: inline-flex;
  justify-content: center;
  align-items: center;
...
`,props:{size:"medium",extended:!1},syncProps:!0}){}H.define("s-fab");class _ extends e({style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  justify-content: center;
...
`,template:u,props:{type:"none"},syncProps:["type"],setup(e){const o=e.querySelector("path");return{watches:{type:e=>{let t=E[e];"object"==typeof t?(o.setAttribute("transform",`rotate(${t.angle} 480 -480)`),t=E[t.name]):o.removeAttribute("transform"),o.setAttribute("d",t)}}}}}){}N.define("s-icon");class B extends e({style:`
:host{
  display: block;
  height: 4px;
  color: var(--s-color-primary, #5256a9);
...
`,props:{group:""},syncProps:["group"],setup(e){const t=e.querySelector(".popup");e=e.querySelector("slot[name=trigger]");const o=t.show.bind(t),r=t.dismiss.bind(t);var n=t.toggle.bind(t);return e.addEventListener("click",e=>{e.stopPropagation(),o()}),this.addEventListener("menu-item:click",e=>{e.stopPropagation(),r()}),{mounted:()=>{this.parentNode instanceof L&&t.setAttribute("showalign","right")},expose:{show:o,dismiss:r,toggle:n}}}}){}class W extends e({style:`
:host{
  display: block;
  height: 44px;
}
...
`,props:{},setup(e){e.querySelector(".container").addEventListener("click",()=>this.dispatchEvent(new Event("menu-item:click",{bubbles:!0})))}}){}L.define("s-popup-menu"),W.define("s-popup-menu-item");class T extends e({style:`
:host{
  display: flex;
  justify-content: center;
  align-items: center;
...
<slot id="slot"></slot>
<slot name="end"></slot>
`,props:{mode:"bottom"},syncProps:!0,setup(e){const o=e.querySelector("#slot");let r=[],n=-1,s=!1;const i=e=>{if(0===r.length||!e.selected)return n=-1;for(const t of r)t!==e&&t.selected&&t.removeAttribute("selected");n=r.indexOf(e),s&&(this.dispatchEvent(new Event("change")),s=!1)};return o.addEventListener("slotchange",()=>{let t=null;n=-1,r=o.assignedElements().filter(e=>{if(e instanceof S)return e.selected&&(t=e),!0}),t&&i(t)}),this.addEventListener("navigation-item:update",e=>{e.stopPropagation(),i(e.target)}),this.addEventListener("navigation-item:change",e=>{e.stopPropagation(),s=!0}),{expose:{get options(){return r},get selectedIndex(){return n}}}}}){}class S extends e({style:`
:host{
  display: flex;
  align-items: center;
  justify-content: center;
...
`,props:{disabled:!1,label:""},syncProps:["disabled"],setup(e){const o=e.querySelector(".popup"),r=e.querySelector("#slot"),t=e.querySelector(".label>span"),n=e.querySelector(".value");let s=[],i=-1,a=!1;const l=e=>{if(0!==s.length&&e.selected){for(const t of s)t!==e&&t.selected&&t.removeAttribute("selected");i=s.indexOf(e),n.textContent=""===s[i]?.value?s[i].textContent:s[i].value,a&&(this.dispatchEvent(new Event("change")),a=!1,o.dismiss())}else n.textContent="",i=-1};return r.addEventListener("slotchange",()=>{let t=null;i=-1,s=r.assignedElements().filter(e=>{if(e instanceof C)return e.selected&&(t=e),!0}),t&&l(t)}),this.addEventListener("picker-item:update",e=>{e.stopPropagation(),l(e.target)}),this.addEventListener("picker-item:change",e=>{e.stopPropagation(),a=!0}),{watches:{label:e=>{t.textContent=e}},expose:{get options(){return s},get selectedIndex(){return i},show:o.show.bind(o),dismiss:o.dismiss.bind(o),toggle:o.toggle.bind(o)}}}}){}class C extends e({style:`
:host{
  display: flex;
  height: 44px;
  align-items: center;
...
`,props:{selected:!1,value:""},syncProps:["selected"],setup(){return this.addEventListener("click",()=>{this.selected||(this.parentNode instanceof z&&this.dispatchEvent(new Event("picker-item:change",{bubbles:!0})),this.selected=!0)}),{watches:{selected:()=>{this.parentNode instanceof z&&this.dispatchEvent(new Event("picker-item:update",{bubbles:!0}))}}}}}){}z.define("s-picker"),C.define("s-picker-item");const P={uncheck:"M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z",checked:"M480-280q83 0 141.5-58.5T680-480q0-83-58.5-141.5T480-680q-83 0-141.5 58.5T280-480q0 83 58.5 141.5T480-280Zm0 200q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"};u=`
<svg class="icon color" viewBox="0 -960 960 960">
  <path d="${P.uncheck}"></path>
</svg>
<s-ripple class="color" attached="true" part="ripple"></s-ripple>
`;class O extends e({style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  align-items: center;
...
`,template:u,props:{disabled:!1,checked:!1,name:""},syncProps:!0,setup(e){const t=e.querySelector("path");return this.addEventListener("click",()=>{this.checked=!0,this.name&&document.querySelectorAll(`${this.tagName}[name='${this.name}']`).forEach(e=>{e!==this&&(e.checked=!1)}),this.dispatchEvent(new Event("change"))}),{watches:{checked:e=>t.setAttribute("d",e?P.checked:P.uncheck)}}}}){}O.define("s-radio-button");u={readOnly:!1,max:10,min:0,value:5,step:1};class X extends e({style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  font-size: 24px;
...
`,props:{size:"medium"},syncProps:!0,setup(e){e.querySelector("[name=dropdown]").addEventListener("mousedown",e=>e.preventDefault())}}){}R.define("s-search");class Z extends e({style:`
:host{
  display: inline-flex;
  align-items: center;
  vertical-align: middle;
...
`,template:"<slot></slot>",props:{},setup(e){const o=e.querySelector("slot");let r=[],n=-1,s=!1;const i=e=>{if(0===r.length||!e.selected)return n=-1;for(const t of r)t!==e&&t.selected&&t.removeAttribute("selected");n=r.indexOf(e),s&&(this.dispatchEvent(new Event("change")),s=!1)};return o.addEventListener("slotchange",()=>{let t=null;n=-1,r=o.assignedElements().filter(e=>{if(e instanceof $)return e.selected&&(t=e),!0}),t&&i(t)}),this.addEventListener("segmented-button-item:update",e=>{e.stopPropagation(),i(e.target)}),this.addEventListener("segmented-button-item:change",e=>{e.stopPropagation(),s=!0}),{expose:{get options(){return r},get selectedIndex(){return n}}}}}){}class $ extends e({style:`
:host{
  flex-basis: 100%;
  display: flex;
  justify-content: center;
...
<slot name="end"></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`,props:{selected:!1,disabled:!1,selectable:!0},syncProps:["selected","disabled"],setup(){return this.addEventListener("click",()=>{!this.selectable||this.selected||(this.parentNode instanceof Z&&this.dispatchEvent(new Event("navigation-item:change",{bubbles:!0})),this.selected=!0)}),{watches:{selected:()=>{this.parentNode instanceof Z&&this.dispatchEvent(new Event("segmented-button-item:update",{bubbles:!0}))}}}}}){}Z.define("s-segmented-button"),$.define("s-segmented-button-item");u={disabled:!1,labeled:!1,ranged:!1,max:100,min:0,step:1,value:0,valueStart:0,valueEnd:0};class D extends e({style:`
:host{
  display: block;
  color: var(--s-color-primary, #5256a9);
  height: 16px;
...
<input
  ...
  value="${u.value}"
/>
`,props:u,syncProps:["disabled","labeled","ranged"],setup(e){const t=e.querySelector(".container"),o=e.querySelector(".indicator"),r=e.querySelector(".track"),n=e.querySelector(".handle"),s=e.querySelector(".label"),i=e.querySelector("input"),a=()=>{var e=Number(i.value),t=100*(e-this.min)/this.max-this.min;n.style.left=`calc(${t}% - ${.16*t}px)`,o.style.width=`calc(${t}% - ${4+.16*t}px)`,r.style.width=`calc(${100-t}% - ${20-.16*t}px)`,s.textContent=String(e)};return i.addEventListener("change",()=>this.dispatchEvent(new Event("change"))),i.addEventListener("input",()=>{this.value=Number(i.value),this.dispatchEvent(new Event("input"))}),i.addEventListener("mousedown",e=>0===e.button&&!d.touched&&t.classList.add("active")),i.addEventListener("mouseup",()=>!d.touched&&t.classList.remove("active")),i.addEventListener("touchstart",()=>d.touched&&t.classList.add("active"),{passive:!0}),i.addEventListener("touchend",()=>d.touched&&t.classList.remove("active"),{passive:!0}),i.addEventListener("touchcancel",()=>d.touched&&t.classList.remove("active"),{passive:!0}),{watches:{max:e=>{i.max=String(e),a()},min:e=>{i.min=String(e),a()},step:e=>{i.step=String(e),a()},value:e=>{i.value=String(e),a()}}}}}){}D.define("s-slider");class M extends e({style:`
:host{
  display: inline-flex;
  vertical-align: middle;
}
...
`,props:{duration:5e3},setup(t){var e=t.querySelector("slot[name=trigger]");const o=t.querySelector(".wrapper");var r=t.querySelector("slot[name=action]");const n={timer:0};var s=()=>{var e=l(t);0===e.top&&0===e.left||o.setAttribute("style",`width: ${innerWidth}px;height: ${innerHeight}px;top: ${0-e.top}px;left: ${0-e.left}px`),clearTimeout(n.timer),getComputedStyle(o).top,o.classList.add("show"),this.dispatchEvent(new Event("show")),0<this.duration&&(n.timer=setTimeout(i,this.duration))};const i=()=>{clearTimeout(n.timer),o.classList.remove("show"),this.dispatchEvent(new Event("dismiss"))};return e.addEventListener("click",s),o.addEventListener("transitionend",e=>{"transform"===e.propertyName&&(e=o.classList.contains("show"),this.dispatchEvent(new Event(e?"showed":"dismissed")))}),r.addEventListener("click",i),{expose:{show:s,dismiss:i}}}}){static show=e=>{let t=document.body;const o=new M;var r=document.body.firstElementChild;r&&"S-PAGE"===r.tagName&&(t=r),"string"==typeof e?o.textContent=e:(e.root&&(t=e.root),o.textContent=e.text,e.action&&((r=document.createElement("s-button")).type="text",r.slot="action",r.textContent=e.action.text,e.action.click&&r.addEventListener("click",e.action.click),o.appendChild(r)),e.duration&&(o.duration=e.duration)),t.appendChild(o),o.addEventListener("dismissed",()=>t.removeChild(o)),o.show()}}M.define("s-snackbar");class Y extends e({style:`
:host{
  display: inline-flex;
  vertical-align: middle;
  align-items: center;
...
`,props:{disabled:!1,checked:!1},syncProps:!0,setup(){this.addEventListener("click",()=>{this.checked=!this.checked,this.dispatchEvent(new Event("change"))})}}){}Y.define("s-switch");class j extends e({style:`
:host{
  display: flex;
  justify-content: center;
  position: relative;
...
`,props:{mode:"scrollable"},syncProps:["mode"],setup(e){const o=e.querySelector("slot"),s=e.querySelector(".container");let i=[],a=-1,l=!1;const r=e=>{if(0===i.length||!e.selected)return a=-1;let t=null;for(const n of i)n!==e&&n.selected&&(t=n).removeAttribute("selected");var o,r;a=i.indexOf(e),l&&(this.dispatchEvent(new Event("change")),l=!1),this.isConnected&&(s.scrollWidth!==s.offsetWidth&&(o=e.offsetLeft-s.offsetWidth+s.offsetWidth/2+e.offsetWidth/2,s.scrollTo({left:o,behavior:"smooth"})),t)&&(t.indicator.addEventListener("transitionend",()=>{t?.indicator.removeAttribute("style"),e.indicator.removeAttribute("style")},{once:!0}),o=t.indicator.getBoundingClientRect().left,r=e.indicator.getBoundingClientRect(),e.indicator.setAttribute("style","transition:none;filter:opacity(0)"),t.indicator.setAttribute("style",`transition: transform .12s, width .12s;filter:opacity(1);transform:translateX(${r.left-o}px);width: ${r.width}px`))};return o.addEventListener("slotchange",()=>{let t=null;a=-1,i=o.assignedElements().filter(e=>{if(e instanceof A)return e.selected&&(t=e),!0}),t&&r(t)}),this.addEventListener("tab-item:update",e=>{e.stopPropagation(),r(e.target)}),this.addEventListener("tab-item:change",e=>{e.stopPropagation(),l=!0}),{expose:{get options(){return i},get selectedIndex(){return a}}}}}){}class A extends e({style:`
:host{
  display: flex;
  align-items: center;
  justify-content: center;
...
<s-ripple attached="true" part="ripple"></s-ripple>
`,props:{selected:!1},syncProps:!0,setup(e){const t=e.querySelector(".container"),o=e.querySelector(".indicator"),r=e.querySelector("[name=icon]");return r.addEventListener("slotchange",()=>{var e=r.assignedElements().length;t.classList[0<e?"add":"remove"]("icon")}),this.addEventListener("click",()=>{this.selected||(this.parentNode instanceof j&&this.dispatchEvent(new Event("tab-item:change",{bubbles:!0})),this.selected=!0)}),{expose:{get indicator(){return o}},watches:{selected:()=>{this.parentNode instanceof j&&this.dispatchEvent(new Event("tab-item:update",{bubbles:!0}))}}}}}){}j.define("s-tab"),A.define("s-tab-item");class F extends e({style:`
:host{
  display: block;
  font-size: .875rem;
  border: solid 1px var(--s-color-outline-variant, #c7c5d0);
...
`,props:{}}){}class G extends e({style:`
:host{
  display: table-header-group;
  font-weight: 600;
  color: var(--s-color-on-surface-variant, #46464f);
}
`,template:"<slot></slot>",props:{}}){}class Q extends e({style:`
:host{
...
`,template:"<slot></slot>",props:{}}){}class V extends e({style:`
:host{
  display: table-row;
}
::slotted(*:first-child){
...
`,template:"<slot></slot>",props:{}}){}F.define("s-table"),G.define("s-thead"),Q.define("s-tbody"),V.define("s-tr"),J.define("s-th"),K.define("s-td");class U extends e({style:`
:host{
  display: inline-grid;
  vertical-align: middle;
  color: var(--s-color-primary, #5256a9);
...
`,props:{label:"",disabled:!1},syncProps:["disabled"],setup(e){const o=e.querySelector(".container"),t=e.querySelector(".label"),r=e.querySelector(".input"),n=e.querySelector(".shadow");let s=null;const i=()=>{s&&(""===s.value?o.classList.remove("empty"):o.classList.add("empty"),s instanceof HTMLTextAreaElement)&&(n.textContent=s.value,s.offsetHeight!==n.offsetHeight)&&(s.style.height=n.offsetHeight+"px")};return r.addEventListener("slotchange",()=>{if((s=r.assignedElements()[0])instanceof HTMLInputElement||s instanceof HTMLTextAreaElement){s instanceof HTMLTextAreaElement?o.classList.add("multi"):o.classList.remove("multi");var e=Object.getOwnPropertyDescriptor(Object.getPrototypeOf(s),"value");if(e){const t=e.set;e.set=e=>{t?.apply(s,[e]),s&&s.parentNode===this&&i()},Object.defineProperty(s,"value",e)}i(),s.addEventListener("input",i)}else n.textContent="",o.classList.remove("multi","empty"),s=null}),{watches:{label:e=>t.textContent=e}}}}){}U.define("s-text-field");class ee extends e({style:`
:host{
  position: relative;
  display: inline-flex;
  vertical-align: middle;
...
`,props:{},setup(n){const s=n.querySelector("#trigger"),i=n.querySelector(".container"),a={showed:!1,timer:0},e=()=>{var e,t,o,r;this.isConnected&&!a.showed&&(e=s.getBoundingClientRect(),t=l(n),o=i.offsetWidth,r=i.offsetHeight,(r={top:e.top-4-r,left:e.left-(o-e.width)/2}).left<0&&(r.left=e.left),r.left+o>innerWidth&&(r.left=e.left+e.width-o),r.top<0&&(r.top=e.top+s.offsetHeight+4),i.setAttribute("style",`left: ${r.left-t.left}px;top: ${r.top-t.top}px`),i.classList.add("show"),a.showed=!0)},t=()=>{this.isConnected&&a.showed&&(i.classList.remove("show"),a.showed=!1)};s.addEventListener("wheel",t,{passive:!0}),s.addEventListener("mouseover",()=>!d.touched&&e(),{passive:!0}),s.addEventListener("mouseleave",()=>!d.touched&&t(),{passive:!0}),s.addEventListener("touchstart",()=>{clearTimeout(a.timer),a.timer=setTimeout(e,600)},{passive:!0}),s.addEventListener("touchend",()=>{clearTimeout(a.timer),t()},{passive:!0}),i.addEventListener("transitionend",()=>{i.classList.contains("show")||i.removeAttribute("style")})}}){}return ee.define("s-tooltip"),Object.freeze({__proto__:null,Appbar:t,Badge:o,Button:i,Card:a,Carousel:h,Checkbox:f,Chip:m,CircularProgress:g,Dialog:y,Divider:w,Drawer:k,FAB:H,Icon:N,IconButton:_,LinearProgress:B,Navigation:T,NavigationItem:S,Page:I,Picker:z,PickerItem:C,Popup:q,PopupMenu:L,PopupMenuItem:W,RadioButton:O,Rate:X,Ripple:s,ScrollView:b,Search:R,SegmentedButton:Z,SegmentedButtonItem:$,Slider:D,Snackbar:M,Switch:Y,Tab:j,TabItem:A,Table:F,Tbody:Q,Td:K,TextField:U,Th:J,Thead:G,Tooltip:ee,Tr:V})})
